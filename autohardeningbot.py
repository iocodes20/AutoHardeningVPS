...
parser = argparse.ArgumentParser(description='Script for hardening a server')
...
client.connect(args.ip, port=args.port, username=args.username, password=args.password)
...
commands = [
    ...
    f'echo "Welcome to {os.uname()[1]}" | sudo tee /etc/issue.net',
